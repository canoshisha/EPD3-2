...
class ImgProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // ]);
        DB::table('img_products')->insert([
            ["routeImg" => "/img/Merchandising1.png", "tipo" => "imagenMenu", "products_id" => 1],
            ["routeImg" => "/img/camisetaAston2.png", "tipo" => "imagen", "products_id" => 1],
            ["routeImg" => "/img/gorraAston1.png", "tipo" => "imagenMenu", "products_id" => 2],
            ["routeImg" => "/img/gorraAston2.png", "tipo" => "imagen", "products_id" => 2],
            ["routeImg" => "/img/Merchandising3.png", "tipo" => "imagenMenu", "products_id" => 3],
            ["routeImg" => "/img/Merchandising4.png", "tipo" => "imagen", "products_id" => 3],
            ["routeImg" => "/img/redbull1.png", "tipo" => "imagenMenu", "products_id" => 4],
            ["routeImg" => "/img/redbull2.png", "tipo" => "imagen", "products_id" => 4],
            ["routeImg" => "/img/gorraRedbull1.png", "tipo" => "imagenMenu", "products_id" => 5],
            ["routeImg" => "/img/gorraRedbull2.png", "tipo" => "imagen", "products_id" => 5],
            ["routeImg" => "/img/gorraFerrari1.png", "tipo" => "imagenMenu", "products_id" => 6],
            ["routeImg" => "/img/gorraFerrari2.png", "tipo" => "imagen", "products_id" => 6],
            ["routeImg" => "/img/gorraMercedes1.png", "tipo" => "imagenMenu", "products_id" => 7],
            ["routeImg" => "/img/gorraMercedes2.png", "tipo" => "imagen", "products_id" => 7],
            ["routeImg" => "/img/macclaren1.png", "tipo" => "imagenMenu", "products_id" => 8],
            ["routeImg" => "/img/macclaren2.png", "tipo" => "imagen", "products_id" => 8],
            ["routeImg" => "/img/gorraMacclaren1.png", "tipo" => "imagenMenu", "products_id" => 9],
            ["routeImg" => "/img/gorraMacclaren2.png", "tipo" => "imagen", "products_id" => 9],
            ["routeImg" => "/img/mercedes1.png", "tipo" => "imagenMenu", "products_id" => 10],
            ["routeImg" => "/img/mercedes2.png", "tipo" => "imagen", "products_id" => 10]
        ]);
    }
}