                                            ...
                                            <div class="card mb-3" style="width: 18rem;">
                                                <div class="card-body">
                                                    ...
                                                    <ul class="list-group">
                                                        ...
                                                        <li class="list-group-item"><strong>Ciudad:</strong>
                                                            {{ $address->city }}</li>
                                                        <li class="list-group-item"><strong>Otra Descripción:</strong>
                                                            {{ $address->other_description }}</li>
                                                ...
                                                <div class="card-footer">
                                                    <a href="{{ route('address.delete', $address->id) }}"
                                                        class="btn btn-danger mb-2">Eliminar Dirección</a>
                                                    <a class="btn btn-primary"
                                                        href="{{ route('address.edit', $address) }}">Editar Dirección</a>
                                                </div>
                                            </div>
                                        @empty
